...
Color primaryColor = const Color(0xFFF6F8FA);
Color darkPrimaryColor = const Color(0xFF191720);
Color whiteBackground = const Color.fromARGB(255, 230, 228, 237);
Color secondaryColor = const Color(0xFFF3EE76);
Color lightBlue = const Color(0xFF79DBFF);
Color greyBg = const Color(0xFFB8B8B8);
...
final TextTheme myTextTheme = TextTheme(
  ...
  headlineLarge: GoogleFonts.poppins(
      fontSize: 22, fontWeight: FontWeight.w600, color: lightBlue),
